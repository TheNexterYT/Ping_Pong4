...
def connect_to_server():
    while True:
        try:
            ...
            client.connect(('0.tcp.eu.ngrok.io', 18067)) # ---- Підключення до сервера
            buffer = ""
            game_state = {}
...
# --- ЗОБРАЖЕННЯ ----
game_bg = image.load("images/stok.jpg")
game_bg = transform.scale(game_bg, (WIDTH, HEIGHT))


# --- ЗВУКИ ---
mixer.music.load("sounds/Dream Raid Full Version (Mock Up).mp3")
mixer.music.set_volume(0.5)
mixer.music.play(-1)

ball_platform_sound = mixer.Sound("sounds/alienshoot1.wav")
ball_platform_sound.set_volume(0.8)

ball_wall_sounds = mixer.Sound("sounds/alienshoot1.wav")
ball_wall_sounds.set_volume(0.6)
# --- ГРА ---
game_over = False
winner = None
you_winner = None
